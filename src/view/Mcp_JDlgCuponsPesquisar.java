...
public class Mcp_JDlgCuponsPesquisar extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mcp_JDlgCuponsPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mcp_JDlgCuponsPesquisar dialog = new Mcp_JDlgCuponsPesquisar(new javax.swing.JFrame(), true);
