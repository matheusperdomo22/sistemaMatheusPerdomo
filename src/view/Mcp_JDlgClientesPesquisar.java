...
public class Mcp_JDlgClientesPesquisar extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mcp_JDlgClientesPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mcp_JDlgClientesPesquisar dialog = new Mcp_JDlgClientesPesquisar(new javax.swing.JFrame(), true);
