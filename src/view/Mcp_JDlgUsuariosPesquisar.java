...
public class Mcp_JDlgUsuariosPesquisar extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mcp_JDlgUsuariosPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mcp_JDlgUsuariosPesquisar dialog = new Mcp_JDlgUsuariosPesquisar(new javax.swing.JFrame(), true);
